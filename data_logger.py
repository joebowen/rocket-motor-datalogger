        ...
        if ch == 'b':
            ...
            for scan in range(count):
                for channel in range(nchan):
                    ...
                    print("Channel {0:d}  Sample[{1:d}] = ".format(channel, ii), hex(dataAIn[ii]),
                          " Volts = {0:7.4f}".format(usb20x.volts(dataAIn[ii])))
        elif ch == 'C':
            ...
            while True:
                ...
                if raw_data:
                    for raw_data_point in raw_data[:16]:
                        print("{0:7.4f}".format(usb20x.volts(raw_data_point)))
