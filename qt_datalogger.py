...
@click.option('--batch-exp', type=int, default=10, help='Data Read Batch Exponent - Default: 12 (ie. 2^12 records per batch)')
...
def main(freq, maxruntime, debug, headless, batch_exp=12):
    column_names = [
        'Load Cell',
        'Chamber Pressure',
        'Tank Pressure',
